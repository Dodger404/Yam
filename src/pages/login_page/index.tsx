    ...
    <div className="login-page">
      <div className="flex flex-col items-center justify-start w-full">
        <div className="bg-white rounded-xl shadow-lg border border-gray-300 max-w-[380px] w-full">
          <div className="flex flex-col gap-10 p-10 px-6">
            <div className="flex flex-col gap-6">
              <h2 className="h2">Вход в аккаунт</h2>
              ...
              <button type="submit" className="w-full bg-blue-500 text-white py-2 rounded-lg text-base-bold">Войти</button>
            </div>
            <div className="flex flex-col gap-2">
              <p className="text-sm text-gray-500">У вас ещё нет аккаунта?</p>
              <a href="#" className="text-blue-500 text-sm-bold">Зарегистрироваться</a>
            </div>
          </div>
        </div>
      </div>
